...
export default function Bookmodal({book , onClose}) {
  return (
    <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justifu-center items-center' onClick={onClose}>
      <div onClick={(event) => event.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
        ...
        <h2 className='w-fit px-4 py-1 bg-red-300 rounded-lg'>{book.publishnumber}</h2>
